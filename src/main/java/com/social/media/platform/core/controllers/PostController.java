...
public class PostController {
    ...
    @Operation(summary = "Find post by user's id",
            description = "You can find any post, if you know user's id.")
    ...
    @Operation(summary = "Find post by its id",
            description = "You can find any post, if you know its id.")
    @ApiResponse(responseCode = "200", description = "Post was found")
    ...
    @Operation(summary = "Look though posts",
            description = "You can look though posts of person you follow.")
    @ApiResponse(responseCode = "200", description = "Post was found")
    @ApiResponse(responseCode = "400", description = "Bad request")
    ...
    @Operation(summary = "Create a new post",
            description = "You can create a new post and add an image to it.")
    ...
    @Operation(summary = "Update your post",
            description = "You can update any of your posts.")
    ...
    @Operation(summary = "Delete post",
            description = "You can delete any of your posts using the post id.")
